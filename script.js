...
function setup() {
  // on charge le modèle
  // Image Model
  // classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/LEkQ9hlV-/model.json");
  // Sound Model
  classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/6BTwYYdFH/model.json");
...
function findMovement(error, results) {
  ...
  // si label est "up", alors je lance ma fonction goUp()

  // si label est "down", alors je lance ma fonction goDown()

  // si label est "right", alors je lance ma fonction goRight()

  // si label est "left", alors je lance ma fonction goLeft()
